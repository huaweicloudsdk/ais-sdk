...
public class PlateNumberDemo {
	 ...
	 * @throws IOException
	 */
	private static void plateNumberDemo() throws IOException {
		//
		...
		try {
			...
			byte[] fileData = FileUtils.readFileToByteArray(new File("data/plate_number_demo.jpg"));
			...
			// 3.传入车牌识别服务对应的uri参数, 传入车牌识别服务需要的参数，
