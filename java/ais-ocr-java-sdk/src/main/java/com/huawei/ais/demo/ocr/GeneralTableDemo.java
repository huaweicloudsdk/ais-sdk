 ...
 *  通用表格OCR服务的使用示例类
 */
public class GeneralTableDemo {
	//
	// 通用表格OCR服务的使用示例函数
	//
	private static void generalTableDemo() throws IOException {
		//
		...
		try {
			//
			// 2.构建访问通用表格识别的使用示例函数服务需要的参数
			//
			String uri = "/v1.0/ocr/general-table";
			byte[] fileData = FileUtils.readFileToByteArray(new File("data/general-table-demo.png"));
