...
if __name__ == '__main__':
    ...
    decode_to_wave_file(result_obj['result']['data'], 'data/modeation_distortion-token-1.png')
    print(result)

    # call interface use the file
    result = distortion_correct(token, encode_to_base64('data/modeation_distortion.jpg'), '', True)
    result_obj = json.loads(result)
    decode_to_wave_file(result_obj['result']['data'], 'data/modeation_distortion-token-2.png')
    print(result)
    ...
    result_obj = json.loads(result)
    decode_to_wave_file(result_obj['result']['data'], 'data/modeation_distortion-aksk-1.png')
    print(result)
