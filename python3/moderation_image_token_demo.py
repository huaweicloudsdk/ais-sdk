...
if __name__ == '__main__':
    ...
    result = moderation_image(region_name, token, encode_to_base64('data/moderation-terrorism.jpg'), "", ['politics','terrorism'], "")
    print(result)

    # call interface use the url (token, image, url, threshold=0.95, scene=None)
    result = moderation_image(region_name, token, "", demo_data_url, ['politics','terrorism'], "")
    print(result)
