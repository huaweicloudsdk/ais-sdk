...
#
TOKEN=''
curl -X POST https://ais.cn-north-1.myhuaweicloud.com/v1.0/image/celebrity-recognition \
  --header 'Content-Type: application/json' \
  --header "X-Auth-Token: $TOKEN" -d'
 {
      "image":"",
      "url":"https://ais-sample-data.obs.cn-north-1.myhwclouds.com/celebrity-recognition.jpg",
      "threshold": 0.48,
}'
