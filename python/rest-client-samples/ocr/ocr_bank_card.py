...
# access ocr idcard
#
def ocr_bank_card(token, image_str=None, url=None, issue=False):
    _url = 'https://ais.cn-north-1.myhuaweicloud.com/v1.0/ocr/bank-card'
...
if __name__ == '__main__':
    ...
    demo_data_url = 'https://obs-hqq.obs.myhwclouds.com/bank.jpg'
